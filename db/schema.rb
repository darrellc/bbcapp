...
ActiveRecord::Schema.define(:version => 20140205173534) do

  create_table "refinery_events_sermon_groups", :force => true do |t|
    t.string   "name"
    t.string   "start_date"
    t.integer  "position"
  ...
  create_table "refinery_sermon_sets", :force => true do |t|
    t.string   "title"
  ...
  create_table "refinery_sermons_services", :force => true do |t|
    t.string   "name"
    t.integer  "position"
    t.datetime "created_at", :null => false
    t.datetime "updated_at", :null => false
  ...
  create_table "refinery_sermons_speakers", :force => true do |t|
    t.string   "name"
    t.integer  "position"
    t.datetime "created_at", :null => false
    t.datetime "updated_at", :null => false
